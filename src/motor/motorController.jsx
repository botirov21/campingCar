...
const MotorController = ({ onClick }) => {
    ...
    return (
        <div style={{display: 'flex'}}>
            ...
            >
                <button active={on}><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 18 18" fill="none">
            ...
            >
                <button active={!on}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 22 22" fill="none">
