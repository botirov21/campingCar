...
import { CarsInfo, CarvanWrapper, RentPrice, } from './caravanStyle'
import caravanImage from '../assets/caravanImage.jpg'
import MenuItem from '@mui/material/MenuItem';
import TextField from '@mui/material/TextField';
import { CaravanCard } from "..//mock/cavravanData";
...
const Caravan = () => {
  ...
  const Caravandata = CaravanCard.carList;
  console.log("hi" , Caravandata)
  return (
    <div style={{ border: "solid black 3px" }}>

      <CarvanWrapper>
        <div className='CaravanTitleDiv'>
          <div className='CaravanTitle'>
            <p className='titlep'>Home / Caravan</p>
            <h3 className='titleText'>Our ranges</h3>
            <h1 className='caravan'>Caravan</h1>
          </div>
        </div>
        <RentPrice>
          ...
          <div className='OrderCarDiv'>
            ...
            <div className='OrderCarDivRight'>
              <div className='OrderCart'>
                {Caravandata.map((value, key) => {
                  return (
                    <Link  to={`/MotorsCar-details/${value.id}`}>
                      <div className='cart' key={key}>
                        {/* <img style={{ width: '200px', height: '130px' }} src={caravanImage} alt="" /> */}
