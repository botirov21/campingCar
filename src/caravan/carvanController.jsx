...
const CarvanController = ({ onClick }) => {
    ...
    return (
        <div style={{display: 'flex', border: '1px solid lightgray', borderTopLeftRadius: '5px',  borderBottomLeftRadius: '5px',borderTopRightRadius: '5px',  borderBottomRightRadius: '5px',  }}>
            ...
            >
                <button style={{padding: '5px', width: '49px', height: '39px', border: 'none', background: 'none'}} active={on}><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 18 18" fill="none">
            ...
            >
                <button style={{padding: '5px', width: '49px', height: '39px',   borderTop: 'none',  borderBottom: 'none', background: 'none', borderLeft: '1px solid rgba(55, 55, 55, 0.30)' , borderRight: 'none' }}  active={!on}><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 22 22" fill="none">
...
export default CarvanController
