...
import '../index.css'
import { CarsInfo } from './caravanStyle';
import { NavLink } from '../motor/motorStyle';

const CaravanH = () => {
    const carData = CaravanCard.carList;
    return (
                ...
                <div className='OrderCarDivRight'>
                    <div className='OrderCart'>
                        {carData.map((value, key) => {
                            return (
                                <NavLink to={`/Caravan-details/${value.id}`}>
                                    <div className='cart' key={key}>
                                        <img style={{width: '202.42px'}} src={caravanImage} alt="" />
