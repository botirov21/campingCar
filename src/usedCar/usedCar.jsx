...
import { CarsInfo,  RentPrice, UsedCarWrapper,   } from './usedCarStyle'
import UsedCarImage from '../assets/usedCar.png'
...
const UsedCar = () => {
    ...
    const UsedCarData = UsedCarCard.carList;
    return (
          ...
          <div className='OrderCarDiv'>
            ...
            <div className='OrderCarDivRight'>
              <div className='OrderCart'>
                {UsedCarData.map((value, key) => {
                  return (
                    <div className='cart' key={key}>
                      <img style={{width: '200px', height: '130px'}} src={UsedCarImage} alt="" />
