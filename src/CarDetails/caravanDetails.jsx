...
import {  ContactWrapper, DetailedInfo, FaqWrapper, QaWrapper, ReviewsWrapper } from './caravanDetailsStyle'
import { useParams } from 'react-router-dom';
import img from '../assets/caravanImage.jpg';
...
const CaravanDetails = () => {
  const { id } = useParams();
  const carDetail = CaravanCard.carList;
