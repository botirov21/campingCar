...
import {  ContactWrapper, DetailedInfo, FaqWrapper, QaWrapper, ReviewsWrapper } from './tunedDetailsStyle'
...
import { CarDetailsWrapper} from './caravanDetailsStyle';
...
const TunedDetails = () => {
  const { id } = useParams();
  const carDetail = TunedCard.carList;
      ...
      <DetailedInfo>
        <div style={{ display: 'flex', gap: '30px', justifyContent: 'center', paddingRight:'60px' }}>
          <div style={{ paddingLeft: '0px' }}>
            <Bounce left>
              <img style={{ width: '626px', height: '361px' }} src={img} alt="" />
            </Bounce>
          </div>
        ...
        <div style={{marginTop: 70}} className='comfortWrapper'>
