...
import {  ContactWrapper, DetailedInfo, FaqWrapper, QaWrapper, ReviewsWrapper } from './usedCarDetailsStyle'
import { useParams } from 'react-router-dom';
import img from '../assets/usedCar.png';
...
const UsedCarDetails = () => {
  const { id } = useParams();
  const carDetail = UsedCarCard.carList;
